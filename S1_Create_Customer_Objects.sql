...
GO
DROP TABLE IF EXISTS [dbo].[S1_PW_Customer]
GO
...
CREATE TABLE [dbo].[S1_PW_Customer](
...
ALTER TABLE [dbo].[S1_PW_Customer]  WITH CHECK ADD  CONSTRAINT [FK_S1_PW_Customer_Import_Batch_Process_Task] FOREIGN KEY([IBPT_ID])
REFERENCES [dbo].[Import_Batch_Process_Task] ([IBPT_ID])
GO
